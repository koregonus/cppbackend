...
public:
    ...
    Dog(std::string name, double x, double y): dog_name{std::move(name)}, id_(dog_count++), coords_{x, y} {}
    ...
    void SetDogOrientation(std::pair<int, int> basis, double speed)
    {
...
public:
    ...
    Dog* AddDog(std::string name, double x, double y);
