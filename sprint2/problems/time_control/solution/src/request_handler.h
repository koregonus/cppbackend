...
constexpr static std::string_view PLAYERS_ACTION_BASED = "/api/v1/game/player/action"sv;
constexpr static std::string_view TIMER_TICK_BASED = "/api/v1/game/tick"sv;
