...
int main(int argc, char** argv) {
    ...
    // Акцептор на этот раз не нужен, так как клиент не принимает подключений. 
    // Он отправляет запрос — и для этого используется сокет, инициализированный контекстом:
