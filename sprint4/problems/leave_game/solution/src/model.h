...
public:
    ...
    void SetDogRetTime(double time_s)
    {
        DogRetirementTime = time_s;
    }

    double GetDogRetTime() const
    {
        return DogRetirementTime;
    }
...
public:
    ...
    std::vector<struct DogLeftDump> CheckPlayers(double limit);
private:
...
public:
    ...
    void UpdateSessionsTime(std::chrono::milliseconds tick_ms, Players& players, std::vector<DogLeftDump>& vec_left_dog);
